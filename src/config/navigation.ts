...
export const NAVIGATION_CONFIG: NavigationItem[] = [
  ...
  { key: 'codes', path: '/codes', icon: 'lucide:gift', isContentType: true, order: 2 },
  { key: 'units', path: '/units', icon: 'lucide:users', isContentType: true, order: 3 },
  { key: 'events', path: '/events', icon: 'lucide:calendar-days', isContentType: true, order: 4 },
];
