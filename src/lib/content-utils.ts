...
/**
 * Categories whose content goes stale when the game updates. Articles in these
 * categories show a "possibly outdated" banner when the last-modified date is
 * older than STALE_AFTER_DAYS. The current contract is the same one used by
 * the freshness audit: boss/strategy pages and tier lists.
 */
